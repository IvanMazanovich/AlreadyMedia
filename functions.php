...
function test_scripts() {
    ...
    wp_enqueue_script( 'swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-element-bundle.min.js', array(), _S_VERSION, true );
...
function my_register_blocks() {
    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(
            'name'              => 'new_block',
            'title'             => __('Новый блок'),
            'description'       => __('Новый блок'),
            'render_callback'   => 'acf_block_render_callback',
            'keywords' => array('новый', 'блок', 'новый блок'),
            'render_template'   => get_template_directory() . '/template-parts/blocks/new-block/new-block.php',
            'enqueue_assets' => function(){
                wp_enqueue_style( 'new_block', get_template_directory_uri() . '/template-parts/blocks/new-block/new-block.css' );
//                wp_enqueue_script( 'new_block', get_template_directory_uri() . '/template-parts/blocks/new-block/new-block.js', array(), '', true );
            },
        ));
    }
}
